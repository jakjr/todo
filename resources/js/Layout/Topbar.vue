<template>
    <nav class="navbar navbar-top navbar-expand navbar-dashboard navbar-dark ps-2 pe-2 pb-1 pt-1 d-none d-lg-block">
        <div class="container-fluid px-0">
            <div class="d-flex justify-content-between w-100" id="navbarSupportedContent">
                <div class="d-flex flex-column align-items-start">
                    <div class="app_title1">{{ $volt.config.layout.app_title1 }}</div>
                    <div class="app_title2">{{ $volt.config.layout.app_title2 }}</div>
                    <div class="app_title3">{{ $volt.config.layout.app_title3 }}</div>
                </div>
                <!-- Navbar links -->
...
<!--                <span-->
<!--                    class="mb-0 font-small fw-bold text-gray-900">User Name</span>-->
<!--                                </div>-->
<!--                            </div>-->
<!--                        </a>-->
